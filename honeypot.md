...
[T-Pot](https://github.com/telekom-security/tpotce) features a suiteof honeypots deployed within Docker containers and uses an ELK Stack to process and visualize the resulting telemetry. <br/>
<br/>
