...
[T-Pot](https://github.com/telekom-security/tpotce) is a multi honeypot platform stored within Docker containers and uses an ELK Stack to process and visualize the resulting telemetry. <br/>
<br/>
